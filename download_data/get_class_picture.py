# -*- coding: utf-8 -*-
"""
@Time    : 2019-11-19 15:36
@Author  : zhangrui
@FileName: get_class_picture.py
@Software: PyCharm
获取指定class名称的图片
"""
import csv
...
# classes = ["Blender", "Coffeemaker", "Oven", "Microwave oven", "Grinder", "Chair", "Refrigerator", "Cake stand",
#            "Wardrobe", "Printer", "Laptop", "Tablet computer", "Camera", "Mobile phone"]
