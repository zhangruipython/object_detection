...
import glob
import time
from object_follow.picture_mix import PictureMix
        ...
        while capture.isOpened():
            ...
            if not success:
                ...
                if frame_index % self.split_len == 0:
                    cv2.imwrite("C:/rongze/data/yike_picture/demo06/" + str(frame_index) + ".jpg", frame)
...
if __name__ == '__main__':
    ...
    picture_stitch = MorePictureJoint(video_path="C:/rongze/data/yike_picture/demo05.mp4", split_len=40)
    ...
    cv2.imwrite("C:\\rongze\\data\\yike_picture\\demo06\\demo_mix01.jpg", stitching_img)
