...
def yolo_v3(image, confidence_threshold, overlap_threshold):
    ...
    model_param = load_model(classes_file="/home/hadoop/Documents/darknet-master-1/darknet-master/data/coco.names",
                             model_configuration="/home/hadoop/Documents/darknet-master-1/darknet-master/cfg/yolov3.cfg",
                             model_weights="/home/hadoop/Documents/darknet-master-1/darknet-master/backup/yolov3.weights")
    detect_param = do_detect(model_param[0], model_param[1], image)
    ...
    if detect_param["detection_coo_list"]:
        for param in detect_param:
            xmin.append(param["pt1"][0])
            ymin.append(param["pt1"][1])
            xmax.append(param["pt2"][0])
            ymax.append(param["pt2"][1])
            labels.append(param["extract_label"])
